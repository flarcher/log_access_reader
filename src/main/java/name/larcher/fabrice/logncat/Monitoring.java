...
public final class Monitoring {
	...
	public interface MetricsGetter {
		...
		/**
		 * @return Maximum section count ever held in an instance of {@link name.larcher.fabrice.logncat.stat.Statistic}.
		 */
		...
		/**
		 * @return The current count of buckets in {@link name.larcher.fabrice.logncat.TimeBuckets}.
		 */
		int getBucketCount();
	}
}
